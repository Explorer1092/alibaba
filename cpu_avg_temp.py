...
from cpu_avg_data import *



def avg_content(name):
	list1=fenduan(name)
	content= '' 
	###--1--###
...
################################################
		content_pertable += '''
	<pre>
	<div id="ct%s" class="table-responsive">
	<a name="ct%s"></a>
	<center>
	<table border="2"  cellpadding="0" width="700" cellspacing="0">
 	<caption><a href="#head">  CPU使用率%s明细  count(%s)</a></caption>
 	<thead>
 	<tr>
    <th>HOST</th>
    <th>Name</th>
